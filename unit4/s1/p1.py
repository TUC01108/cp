...
def extract_nft_names(nft_collection):
    ...
    return nameList
    pass
# Evaluate the time and space complexity of your solution. Define your variables and provide a rationale for why you believe your solution has the stated time and 
# space complexity.
# Time = O(n)
# Space = O(n)
